...
RUN mkdir ~/qt-source && wget http://mirrors.ocf.berkeley.edu/qt/archive/qt/5.11/5.11.1/single/qt-everywhere-src-5.11.1.tar.xz -o ~/qt-source/qt-everywhere-src-5.11.1.tar.xz && md5sum ~/qt-source/qt-everywhere-src-5.11.1.tar.xz && cd ~/qt-source && tar xvf qt-everywhere-src-5.11.1.tar.xz
