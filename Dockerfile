...
RUN mkdir ~/qt-inst && cd ~/qt-inst && curl http://mirrors.ocf.berkeley.edu/qt/archive/qt/5.11/5.11.1/single/qt-everywhere-src-5.11.1.tar.xz -O qt-everywhere-src-5.11.1.tar.xz && md5sum qt-everywhere-src-5.11.1.tar.xz
